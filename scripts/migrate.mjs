...
async function run() {
  ...
  const tasks = [
    ...
    { name: 'Launch Instagram brand campaign', description: 'Plan and execute Q2 brand awareness campaign on Instagram', owner: pick(2), department: 'Marketing & Branding', priority: 'High', status: 'Pending', deadline: d(7), notes: 'Budget approved. Need content calendar.', tags: ['instagram', 'campaign', 'social-media'] },
    ...
    { name: 'Website performance optimization', description: 'Improve page load speed to under 2 seconds', owner: pick(0), department: 'Technology', priority: 'Medium', status: 'Pending', deadline: d(14), notes: 'Lighthouse audit shows 45 score. Target 90+.', tags: ['performance', 'website', 'optimization'] },
    ...
    { name: 'Courier partner evaluation', description: 'Evaluate and shortlist 3 courier partners for pan-India delivery', owner: pick(2), department: 'Operations & Logistics', priority: 'High', status: 'Pending', deadline: d(5), notes: 'RFQ sent to 5 partners. Deadline for response: this week.', tags: ['courier', 'logistics', 'delivery'] },
    { name: 'Product quality testing batch #3', description: 'Send batch #3 for third-party quality testing', owner: pick(0), department: 'Packaging & Product', priority: 'Critical', status: 'Pending', deadline: d(1), notes: 'Lab confirmed slot for Tuesday', tags: ['quality', 'testing', 'product'] },
    { name: 'Draft vendor payment terms template', description: 'Create standardized payment terms for all new vendors', owner: pick(1), department: 'Legal & Finance', priority: 'Low', status: 'Pending', deadline: d(20), notes: '', tags: ['legal', 'vendor', 'templates'] },
    { name: 'Setup CRM for lead tracking', description: 'Configure basic CRM to track inbound leads and customer enquiries', owner: pick(2), department: 'Technology', priority: 'Medium', status: 'Pending', deadline: d(15), notes: 'Evaluating HubSpot free vs Zoho', tags: ['crm', 'leads', 'sales'] },
    ...
    { name: 'Social media content calendar - June', description: 'Plan content calendar for all social platforms for June', owner: pick(1), department: 'Marketing & Branding', priority: 'Medium', status: 'Pending', deadline: d(8), notes: 'Align with product launch schedule', tags: ['content', 'social-media', 'planning'] },
    { name: 'Raw material procurement - Q3', description: 'Procure raw materials for Q3 production run', owner: pick(2), department: 'Vendor & Procurement', priority: 'High', status: 'Pending', deadline: d(18), notes: 'Need to lock prices before monsoon season', tags: ['procurement', 'raw-materials', 'q3'] },
    { name: 'Employee onboarding documentation', description: 'Create onboarding docs and checklist for new hires', owner: pick(0), department: 'Operations & Logistics', priority: 'Low', status: 'Pending', deadline: d(25), notes: '', tags: ['hr', 'documentation', 'onboarding'] },
    { name: 'Mobile app wireframes', description: 'Design wireframes for the Tirtam mobile app', owner: pick(1), department: 'Technology', priority: 'Low', status: 'Pending', deadline: d(30), notes: 'Phase 2 project. Low priority for now.', tags: ['mobile', 'design', 'app'] },
